...
public class PurchasePayments extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String purchasepayment = prefs.getString("PAYMENTHIST","");

        String[] res = purchasepayment.split("\\*");
        ArrayList<PurchasePayment> payment_list = new ArrayList<PurchasePayment>();
        ...
        ArrayAdapter<PurchasePayment> adapter = new PurchasePaymentsArrayAdapter(this, payment_list);
